...
public class LodgingVO {
	...
	public String toString() {
		return "LodgingVO [lodgingId=" + lodgingId + ", lodgingName=" + lodgingName + ", leaseId=" + leaseId
				+ ", cateCode=" + cateCode + ", cateName=" + cateName + ", lodgingPrice=" + lodgingPrice
				+ ", lodgingStock=" + lodgingStock + ", lodgingIntro=" + lodgingIntro + ", lodgingContents="
				+ lodgingContents + ", regDate=" + regDate + ", updateDate=" + updateDate + ", imageList=" + imageList
				+ "]";
	}
