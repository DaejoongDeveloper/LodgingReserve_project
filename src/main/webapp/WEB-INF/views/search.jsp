...
<meta charset="UTF-8">
<title>숙박 예약</title>
<link rel="stylesheet" href="resources/css/search.css?azsdfqffq">
<script
					...
					<table class="type_list">
						...
						<tbody id="searchList>">
							<c:forEach items="${list}" var="list">
								<tr>
									<td class="image">
										<div class="image_wrap" data-lodgingid="${list.imageList[0].lodgingId}" data-path="${list.imageList[0].uploadPath}" data-uuid="${list.imageList[0].uuid}" data-filename="${list.imageList[0].fileName}">
											<img>
										</div>
									</td>
									<td class="detail">
