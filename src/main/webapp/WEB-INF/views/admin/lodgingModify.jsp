			...
			<form action="/admin/lodgingModify" method="post" id="modifyForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="leaseId_input" readonly="readonly"
							value="${lodgingInfo.leaseId}"> <input id="leaseId_input"
							name="leaseId" type="hidden" value="${lodgingInfo.leaseId}">
				...
				<div class="form_section">
					...
					<div class="form_section_content bct">
						...
						<span class="ck_warn lodgingContents_warn">목차를 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
                    			<div class="form_section_title">
				...
				<input type="hidden" name='lodgingId' value="${lodgingInfo.lodgingId}">
			</form>
...
<script>
	...
	$("#modifyBtn").on("click",function(e){
		...
		let lodgingIntro = $(".bit p").html();
		let lodgingContents = $(".bct p").html();	
