...
<link rel="stylesheet" href="../resources/css/admin/leaseList.css?aaffdb">
...
$(document).ready(function(){
    ...
    function checkResult(result){
        ...
        alert("숙소'${enroll_result}'을 등록하였습니다.");
    }
    
		function checkmResult(mresult){
		
		if(mresult === '1'){
			alert("숙소 정보 수정을 완료하였습니다.");
		} else if(mresult === '0') {
			alert("숙소 정보를 수정 하지 못하였습니다.")	
		}
		...
		if(delete_result == 1){
			...
			alert("해당 데이터를 사용하고 있는 데이터가 있어서 삭제 할 수 없습니다.")
	}
});
